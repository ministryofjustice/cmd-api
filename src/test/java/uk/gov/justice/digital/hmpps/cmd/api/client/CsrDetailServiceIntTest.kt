...
class CsrDetailServiceIntTest(
  ...
  inner class UserDetails {
    ...
    fun testUserDetails() {
      ...
      RegionContext.setRegion(1)
      val responseBody = detailService.getStaffDetails(LocalDate.parse("2022-03-10"), LocalDate.parse("2022-03-20"))
  ...
  inner class Notification {
    ...
    fun testDeleteOld() {
      ...
      RegionContext.setRegion(1)
      assertThat(detailService.deleteOld(LocalDate.parse("2022-03-03")))
        .contains("Deleted 2 rows up to 2022-03-03, time taken ")
